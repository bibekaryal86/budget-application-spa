...
export const ASSET_ACCOUNT_TYPES = ['CASH', 'CHECKING', 'SAVINGS']
export const DEBT_ACCOUNT_TYPES = ['CREDIT', 'LOAN']
export const INVEST_ACCOUNT_TYPES = ['INVESTMENT', 'OTHER']
export const ACCOUNT_TYPES = [...ASSET_ACCOUNT_TYPES, ...DEBT_ACCOUNT_TYPES, ...INVEST_ACCOUNT_TYPES]
